...
import { shareProject, unshareProject, getProjectCollaborators, updateCollaboratorPermission } from '@/lib/actions/sharing'
...
export function ShareProjectDialog({ projectId, projectName, isOwner }: ShareProjectDialogProps) {
    ...
    const handleRemove = async (userId: string) => {
        ...
        try {
            const result = await unshareProject(projectId, userId)
            if (result.success) {
    ...
    const handlePermissionChange = async (userId: string, newPerm: string) => {
        ...
        const result = await updateCollaboratorPermission(projectId, userId, newPerm as any)
        if (!result.success) {
            // Revert on failure
            fetchCollaborators()
